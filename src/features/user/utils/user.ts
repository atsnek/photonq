import { Edge_1_2_3_4_5_6, ObjectAndUser, Privacy, Query, User } from "@snek-functions/origin/dist/schema.generated";
 ...
 */
export const buildUserActivities = (q: Query, activityEdges: Edge_1_2_3_4_5_6[], currentUser: t.Nullable<User>): TPaginationData<TActivity[]> => {
